<div class="modal fade" id="paymentModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
                ...
                <div class="card-body p-5">
                    <div class="row my-auto text-center my-5 p-3">
                        <div class="col-12 text-center text-@yield('color')">
                            <h4 class="h2 text-@yield('color')">Método de pago</h4>
                            <p class="text-@yield('color')">Elige de donde salrá el dinero para pagar</p>
                        </div>
                        <div class="col-6">
